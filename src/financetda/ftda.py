...
class FinanceTDA:
    """
    FinanceTDA class for computing persistence diagrams and analyzing financial time series data.
    ...
    **kwargs : dict
    ...
    info : dict
        Additional information about the FinanceTDA instance.
    ...
    def __repr__(self) -> str:
        """Return the string representation of the FinanceTDA instance.

        Returns
        -------
        str
            The string representation of the FinanceTDA instance.
        """
